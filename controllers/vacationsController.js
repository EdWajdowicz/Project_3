...
module.exports = {
  ...
  create: (req, res, next) => {
    ...
    Vacations.create(vacationParams)
      .then(Vacations => {
        res.locals.redirect = "/vacations";
        res.locals.vacation = Vacations;
        next();
      })
      .catch(error => {
  ...
  update: (req, res, next) => {
    ...
    Vacations.findByIdAndUpdate(vacationId, {
      $set: vacationParams
    })
      .then(vacation => {
  ...
  delete: (req, res, next) => {
    let vacationId = req.params.id;
    Vacations.findByIdAndRemove(vacationId)
      .then(() => {
        res.locals.redirect = "/vacations";
        next();
      })
